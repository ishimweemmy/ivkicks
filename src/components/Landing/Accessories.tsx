...
const Accessories: FC = () => {
  return (
    <div className="w-full h-[120vh] flex flex-col md:flex-row xLgMd:h-fit md:h-fit lgMd:h-fit xl:h-[55vh] 2xl:h-[55vh]">
      <div className="w-full h-1/2 bg-[#02BE83] z-10 flex flex-col items-center justify-start relative gap-[2rem] pb-[2rem] xLgMd:flex-row md:flex-row xLgMd:h-[25rem] md:h-[25rem] md:gap-0 xLgMd:gap-0 xl:h-full 2xl:h-full">
        <div
        ...
        ></div>
        <div className="w-2/3 h-1/2 relative flex items-center justify-center md:w-1/2 xLgMd:w-1/2 md:h-full">
          <img src={football} alt="" className="absolute z-10 xl:scale-[1.2]" />
          <img
            src={fback}
            alt=""
            className="absolute right-[8%] bottom-[3%] w-[60%] md:bottom-[25%] xLgMd:bottom-[18%] xLgMd:right-[15%]"
          />
        </div>
        <div className="w-1/2 flex flex-col gap-4 justify-center items-center md:items-start xLgMd:items-start md:gap-[2rem]">
          <span className="text-[#0A083A]">Accessories</span>
          <h1 className="text-white text-4xl font-bold md:text-start">
            Football
          </h1>
          <p className="text-white text-center px-16 xLgMd:text-start md:text-start md:px-0 md:z-10 sm:px-0">
      ...
      <div className="w-full h-1/2 bg-[#0A083A] flex flex-col items-center justify-start relative xLgMd:flex-row md:flex-row xLgMd:h-[25rem] md:h-[25rem] md:gap-0 xLgMd:gap-0 xl:h-full 2xl:h-full">
        <div
          className="absolute w-10 h-10 rounded-full right-4 top-[12rem]"
          style={{
            background:
