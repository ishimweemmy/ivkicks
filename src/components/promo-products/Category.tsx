...
const Category: FC<CategoryProps> = (props) => {
  ...
  return (
    <div
      className={`w-full h-full bg-no-repeat bg-cover flex items-end justify-center pb-[1rem] group transition duration-300 md:justify-start md:pl-8 relative z-10 hover:scale-[.9] ${id == 1 ? "md:col-span-2" : id == 4 ? "md:col-span-2" : ""}`}
