...
const Circle = () => {
  ...
  return (
    <div className="w-[18rem] h-[10rem] rounded-t-full border-4 border-[#ffffff94] border-dotted border-b-0 flex items-end justify-center pb-[1rem] relative minSm:scale-[1.4] lsm:scale-[2] md:scale-[2.4] lgMd:scale-[2.6] xLgMd:scale-[2.8] circleLg:scale-[3] transition-all duration-1000 " style={{ borderTopColor: `${hover ? '#FF3C78' : ''}`, borderRightColor: `${hover ? '#FF3C78' : ''}` }}>
