...
const CategoryProduct: FC<CategoryProductProps> = (props) => {
  ...
  return (
    <Fade bottom><div className="w-full h-[20rem] rounded-xl bg-[#f5f5f5] p-2 px-3 flex flex-col items-center justify-center md:items-start max2xl:h-[25rem] 2xl:h-[30rem]">
    <div
