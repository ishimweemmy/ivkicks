      ...
      <div className="h-fit w-full grid grid-cols-1 grid-rows-aboutTop lssm:grid-rows-aboutTopResponsive place-items-center gap-5 mb-[2rem] md:grid-cols-3 md:px-2 md:grid-rows-aboutTopMd xl:grid-rows-aboutTopLarge xlarge:mt-[5rem]">
        ...
        <Zoom delay={2000}>
          <div
            ...
            style={{
              backgroundImage: `url({import.meta.env.MEDIA_STORAGE_URL +mcQueenWear.jpeg")`,
          ...
          >
            ...
            <Flip delay={3500} duration={1000} top>
              ...
              >
                ...
                <img
                  src={import.meta.env.MEDIA_STORAGE_URL +"Ellipse 6.png"}
                  alt=""
                  className="w-8"
                />
        ...
        <Zoom delay={1000}>
          <div
            ...
            style={{
              backgroundImage: `url({import.meta.env.MEDIA_STORAGE_URL +nikeShoes.jpg")`,
              backgroundPosition: "center",
            }}
          >
            <div
            ...
            <Trending
              imgSrc={import.meta.env.MEDIA_STORAGE_URL +"nikeShoes.jpg"}
              name="Nike Air 780c"
              price={890}
              size={8}
              category="male"
        ...
        <Zoom delay={1500}>
          <div
            ...
            style={{
              backgroundImage: `url({import.meta.env.MEDIA_STORAGE_URL +yeezyBoost.jpg")`,
              backgroundPosition: "center",
            }}
          >
