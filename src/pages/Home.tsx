    ...
    <div className="w-screen h-fit flex sm:flex-col xs:flex-col relative overflow-hidden">
      ...
      >
        <div className="w-full flex flex-col gap-5 md:pl-[2rem] md:gap-[3rem]">
          ...
          <div className="flex flex-col items-start justify-center gap-[1rem] pl-24 mt-[1rem] md:justify-start md:pl-0 md:flex-row md:gap-[4rem] xMiniTablet:items-center xMiniTablet:mr-[25%] lsm:ml-[10%] md:pt-4 lssm:items-center lssm:mr-[50%]">
