            ...
            <div className="hidden lg:flex lg:h-[5rem] flex-grow items-center justify-center gap-[5rem] transition-all self-end">
              {links.map((link) => {
                if(link.displayName == "Products") {
                  return <div
                          className={`text-lg font-medium text-[#FF3C78] grid grid-cols-1 justify-items-center whitespace-nowrap after:w-[.5rem] after:h-[.5rem] after:rounded-full transition-all duration-700 after:animate-ping relative  transition `}
                          style={{
                            color: `${
                              location.pathname == "/about" ||
                              location.pathname == "/products/promoProducts"
                        ...
                        >
                          ...
                          <div className={`w-fit h-fit p-4 gap-1 ${
                              ...
                              location.pathname == "/products/promoProducts"
                                ? "bg-[#ffffff50]"
                                : "bg-[#fff] "
                            } rounded-xl absolute top-8 flex flex-col items-center text-base shadow-2xl shadow-[#ffffff2d] navDropdown `}>
