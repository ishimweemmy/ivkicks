            ...
            <div className="hidden lg:flex lg:h-[5rem] flex-grow items-center justify-center gap-[5rem] transition-all self-end">
              {links.map((link) => {
                if(link.displayName == "Products") {
                  return <div
                          className={`text-lg font-medium text-[#FF3C78] grid grid-cols-1 justify-items-center whitespace-nowrap after:w-[.5rem] after:h-[.5rem] after:rounded-full after:bg-[#FF3C78] after: transition-all duration-700 after:animate-ping relative `}
                          style={{
                            color: `${
                              location.pathname == "/about" ||
                              location.pathname == "/products/promoProducts"
